  ...
  return (
    <main>
      ...
      <div className="w-full px-3 py-5 bg-white mt-4 h-full rounded-lg">
        <HeaderForm title="Detail Aset Sewa" link="/admin/asset/sewa-tenant" />
        {isLoading ? (
          <Loading />
        ) : (
              ...
              <div className="md:grid md:grid-cols-2 md:gap-3">
                <div className="w-full">
                  ...
                  <div className="pt-2 flex flex-col gap-2">
                    ...
                    <TenantInfo
                      label="Tenant"
                      value={data?.application?.asset?.tenants?.tenant}
                    />
                    <TenantInfo
                      label="Alamat"
                      value={data?.application?.asset?.tenants?.address}
                    />
                    <div className="flex gap-8">
                      <TenantInfo
                        label="Bangunan"
                        value={`${data?.application?.asset?.tenants?.building}`}
                      />
                      <TenantInfo
                        label="Lantai"
                        value={`${data?.application?.asset?.tenants?.floor} Lantai`}
                      />
                    </div>
                  </div>
                </div>
